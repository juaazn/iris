...
export default function Sara () {
  return (
    <LayoutContent imgBackground='flores-background-sara'>
      ...
      <VideoDraw
      name='Sara'url
      urlIframe='https://video.eko.com/preview/Vo1O6x?url=%2F%2Fstage.eko.com%2Fprojects%2FMQXBNN%2Ffc42edc1-e227-11ed-8d04-f19f01e44f76%2Farchive%2Fpreview%2F1683078610200%2Fembed.html&APIVersion=4.0.0&autoplay=true'/>
    </LayoutContent>
  )
}
